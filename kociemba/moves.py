...
fname = path.join(relative_path, "move_twist")
if not path.isfile(fname):
    ...
    with open(fname, "wb") as fh:
        np.save(fh, twist_move, allow_pickle=False)
else:
...
fname = path.join(relative_path, "move_flip")
if not path.isfile(fname):
    print("creating " + fname + " table...")
    ...
    for i in range(N_FLIP):
        ...
        for j in enums.Color:
            ...
            a.edge_multiply(cb.basicMoveCube[j])
    with open(fname, "wb") as fh:
        np.save(fh, flip_move, allow_pickle=False)
else:
    # print("loading " + fname + " table...")
    with open(fname, "rb") as fh:
...
fname = path.join(relative_path, "move_slice_sorted")
if not path.isfile(fname):
    print("creating " + fname + " table...")
    ...
    for i in range(N_SLICE_SORTED):
        ...
        for j in enums.Color:
            ...
            a.edge_multiply(cb.basicMoveCube[j])
    with open(fname, "wb") as fh:
        np.save(fh, slice_sorted_move, allow_pickle=False)
    print()
else:
    # print("loading " + fname + " table...")
    with open(fname, "rb") as fh:
...
fname = path.join(relative_path, "move_u_edges")
if not path.isfile(fname):
    print("creating " + fname + " table...")
    ...
    for i in range(N_SLICE_SORTED):
        ...
        for j in enums.Color:
            ...
            a.edge_multiply(cb.basicMoveCube[j])
    with open(fname, "wb") as fh:
        np.save(fh, u_edges_move, allow_pickle=False)
    print()
else:
    # print("loading " + fname + " table...")
    with open(fname, "rb") as fh:
...
fname = path.join(relative_path, "move_d_edges")
if not path.isfile(fname):
    print("creating " + fname + " table...")
    ...
    for i in range(N_SLICE_SORTED):
        ...
        for j in enums.Color:
            ...
            a.edge_multiply(cb.basicMoveCube[j])
    with open(fname, "wb") as fh:
        np.save(fh, d_edges_move, allow_pickle=False)
    print()
else:
    # print("loading " + fname + " table...")
    with open(fname, "rb") as fh:
...
fname = path.join(relative_path, "move_ud_edges")
if not path.isfile(fname):
    print("creating " + fname + " table...")
    ...
    for i in range(N_UD_EDGES):
        ...
        for j in enums.Color:
            ...
            a.edge_multiply(cb.basicMoveCube[j])
    with open(fname, "wb") as fh:
        np.save(fh, ud_edges_move, allow_pickle=False)
    print()
else:
    # print("loading " + fname + " table...")
    with open(fname, "rb") as fh:
...
fname = path.join(relative_path, "move_corners")
if not path.isfile(fname):
    print("creating " + fname + " table...")
    ...
    for i in range(N_CORNERS):
        ...
        for j in enums.Color:
            ...
            a.corner_multiply(cb.basicMoveCube[j])
    with open(fname, "wb") as fh:
        np.save(fh, corners_move, allow_pickle=False)
    print()
else:
    # print("loading " + fname + " table...")
    with open(fname, "rb") as fh:
